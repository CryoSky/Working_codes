...
# Example in Linux: python /mnt/e/linux/script/Calculate_Q_value_pdb1_pdb2_var_length_no_output.py T1003/3D-JIGSAW_SL1_TS1.pdb T1003_reference_6hrh_A.pdb 0 --start1 30 --end1 465
        ...
        for res in chain:
            ...
            if (hetero_flag == ' ' or hetero_flag == 'H_MSE' or hetero_flag == 'H_M3L' or hetero_flag == 'H_CAS') \
                ...
                if sequence_id_flag == 0:
                    ...
                    if last_sequence_id != int(sequence_id) - 1: pass #pass simply does nothing, while continue goes on with the next loop iteration
...
def main():
    parser = argparse.ArgumentParser(
        description="This script calculates Q value for all chains in two pdbs and only output Q value, work for batch outputs in Calculate_all_scores_CASP13.py.")
