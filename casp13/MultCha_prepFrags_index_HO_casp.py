...
find_homologue = "psiblast -db " + database + " -query " + fasta +" -num_iterations 1 -word_size 2 -evalue 0.005 -matrix BLOSUM62 -outfmt '6 sseqid slen bitscore score evalue pident'"
